        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-400 mb-8 leading-relaxed">
              Track token consumption, query volume, and active sessions across your entire organization. ForgeMind's analytics engine provides real-time visibility into how your teams are utilizing the knowledge base.
            </p>
          ...
          <m.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="relative w-full aspect-square md:aspect-[4/3] rounded-3xl liquid-glass border border-white/10 p-6 flex flex-col gap-4 overflow-hidden"
          >
             <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5">
                  ...
                  <div className="text-2xl font-bold text-white">94ms</div>
                  <div className="text-xs text-green-400 mt-1">↓ 5ms vs last week</div>
                </div>
             </div>
             
             <div className="flex-1 rounded-xl bg-white/[0.02] border border-white/5 p-4 flex flex-col justify-end gap-2 overflow-hidden">
                <div className="text-xs text-slate-400 mb-4">Query Volume (30 days)</div>
